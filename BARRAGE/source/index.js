...
class Barrage {
    ...
    init() {
        ...
        this.opacity = this.obj.context || this.context.opacity
        ...
        this.width = p.clientWidth //获取当前容器的宽度
